...
| 4736-114 | 142 | ❓ | ⚪ UNKNOWN | ❓ | initial visit. NOTE 2026-06-17: 10.179.42.1 is NOT this train — box1-t42 is an fv5 train (hostnames fv5-*-229, fv5 template pkg, 15sw+20AP, vlan7 .242.130) = 4705-101 / Fzg 229. 4736-114 CCU IP still unknown. |
...
| 4706-102 | 190 | ❓ | ⚪ UNKNOWN — ⚠️ CCU IP WAS WRONG | ❓ | ⚠️ 2026-06-15 CORRECTION: `10.179.15.1` does NOT belong to this train. box1-t15 is live = **nv6 (not fv6)**, misimaged: broken formula `128 + box-id(15) = 143` renders hostnames `nv6-*-v7-143` + vlan7 199.130 (collides with real 4736-115/Fzg143 at box18). box15's true Fzg is UNKNOWN (physical-assignment fact). True CCU IP for 4706-102 not yet identified. See findings/dosto_train_list_2026-06-15.md. |
